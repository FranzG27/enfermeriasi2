    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                ...
                <div class="d-inline">
                    <h5>enfermero </h5>
                    <span>actualizar enfermero</span>
                </div>
            </div>
        </div>
<div class="col-lg-4">
...
<div class="card-body">
<form class="forms-sample" action ="{{route('nurse.update',[$user->id])}}" method="post" enctype="multipart/form-data">@csrf
    @method('PUT')
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select name="gender" class="form-control @error('gender') is-invalid @enderror" id="exampleSelectGender">
                   @foreach (['Hombre','Mujer','NoBinario'] as  $gender)
